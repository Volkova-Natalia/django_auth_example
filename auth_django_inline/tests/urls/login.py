...
class LoginTestCase(TestCase):
    ...
    url_expected = '/' + base_url_expected + 'login/'  # '/auth-django-inline/login/'
    view_expected = namespace_expected + ':' + 'login'   # 'auth-django-inline:login'
    func_expected = app_name + '.' + 'views.login.' + 'Login'
