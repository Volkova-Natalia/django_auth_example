...
class LogoutTestCase(TestCase):
    ...
    url_expected = '/' + base_url_expected + 'logout/'  # '/auth-django-inline/logout/'
    view_expected = namespace_expected + ':' + 'logout'   # 'auth-django-inline:logout'
    func_expected = app_name + '.' + 'views.logout.' + 'Logout'
